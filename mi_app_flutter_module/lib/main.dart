...
void main() {
  runApp(const MiAppFlutterModule());
}

class MiAppFlutterModule extends StatelessWidget {
  const MiAppFlutterModule({super.key});
...
class MiAppFlutterPlugin {
  static Widget createWidget() {
    return const PaletteGeneratorPage();
  }

  static Widget createApp() {
    return const MiAppFlutterModule();
  }
}
